    ...
    return (
        <div className="sidebar-cont">
            ...
            <section >
                ...
                <div className="about-cont" onClick={() => navigate("/about")}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-exclamation-square-fill" viewBox="0 0 16 16">
                ...
                <div className="blog-cont" onClick={() => window.location.href = "https://distill.pub"}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-chat-left-quote-fill" viewBox="0 0 16 16">
