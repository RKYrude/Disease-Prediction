...
function Home() {
    ...
    async function handleSave() {
        ...
        const underscoredSelectedSymptoms = selectedSymptoms.map(symptom => symptom.replace(/\s+/g, "_"));

        formDataToSend.append('symptoms', underscoredSelectedSymptoms)

        try {            
            const response = await axios.post('http://127.0.0.1:5000/predict', formDataToSend);
